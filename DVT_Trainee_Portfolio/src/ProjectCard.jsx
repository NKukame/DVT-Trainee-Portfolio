        ...
        <div class="search-card">
            ...
            <div class="card__content">
                <p className="card__title">Project Name</p>
                 <p className="project__techstack"><strong>Tech Stack:</strong> HTML, CSS, JS</p>
                 <p className="project__contributors"><strong>Contributors:</strong> Bob Johnson, Alice Smith</p>
                 <p className="card__description">Scientific calculator blah blah blah.</p>
