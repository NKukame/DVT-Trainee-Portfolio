...
function TabButton({ text, Icon, handleSearchFilter, isPeopleSearch }) {
  return (
    <button
      className={`flex-row align-items-center font-size-20-px btn-tab gap-10-px font-weight-400 text-gray ${
        !isPeopleSearch ? 'btn-tab-active border-radius-10-px text-black' : ''
      }`}
