    ...
    <>
      <div className="LoginApp">
        <div className={`login-container ${isSignUp ? "login-active" : ""}`}>
          {/* Mobile forms container for sliding animation */}
                  ...
                  <div className="sign-in-h6">
                    ...
                    <div className="password-container">
                      <input
                        ...
                        onChange={handleChange}
                        className={
                          getInputClass("password") + " password-input"
                        }
                      />
                      {isPasswordVisible ? (
                        <Eye
            ...
            <div className="form-container sign-up">
              <form onSubmit={handleSubmit}>
                ...
                <div className="sign-up-form">
                  ...
                  <div className="password-container-signup">
                    ...
                    {isPasswordVisible ? (
                      ...
                      <EyeClosed
                        className="eyeclosed-icon-signup"
                        strokeWidth="1"
                        size={"20px"}
                        onClick={(event) => {
                          handleToggle(event, true);
                ...
                <div className="button-section">
                  ...
                  <div className="sign-in-link">
                    <p className="signInBlack">Already have an account?</p>
                    <section
          ...
          {/* Mobile form toggle - visible on mobile only */}
          {/* <div className="mobile-form-toggle">
            {!isSignUp ? (
              <p >
                Don't have an account?{" "}
                
                <button className="toggle-button-mobile"
                  onClick={(e) => {
                    e.preventDefault();
                    setIsSignUp(true);
                    setFormData(prev => ({
              ...
              <p>
                ...
                <a className="toggle-button-mobile"
                  onClick={(e) => {
                    e.preventDefault();
                    setIsSignUp(false);
                    setFormData(prev => ({
