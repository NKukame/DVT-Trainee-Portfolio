...
function GenerateCV(){
    ...
    const sortedCareer = [...location.state.career].sort((a, b) => {
                          ...
                          (location.state.projects || []).flatMap((proj) => {
                            ...
                            return projectIndustries.flatMap((ind) => {
                              ...
                              if (ind?.project?.industries) {
                                return ind.project.industries.map(
                                  (item) => item?.industry?.name || "Unknown"
                                );
                              }
                              return "Unknown";
                            });
